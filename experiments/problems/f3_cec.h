...
#include "../../external/cec2013_benchmark_functions/include/cec2013/F3.h"
#include <decomposition/optimization_problem.h>

#ifndef CONTINUOUS_NON_LINEAR_OPTIMIZATION_F3_H
#define CONTINUOUS_NON_LINEAR_OPTIMIZATION_F3_H

using namespace decompose;

class f3_cec : public optimization_problem {
  public:
  ...
  public:
    explicit f3_cec(size_t dimension, std::vector<scalar> lower_bound,
...
#endif // CONTINUOUS_NON_LINEAR_OPTIMIZATION_F3_H
