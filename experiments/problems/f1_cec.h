...
#include "../../external/cec2013_benchmark_functions/include/cec2013/F1.h"
#include <decomposition/optimization_problem.h>

#ifndef CONTINUOUS_NON_LINEAR_OPTIMIZATION_F1_H
#define CONTINUOUS_NON_LINEAR_OPTIMIZATION_F1_H

using namespace decompose;

class f1_cec : public optimization_problem {
  public:
  ...
  public:
    explicit f1_cec(size_t dimension, std::vector<scalar> lower_bound,
